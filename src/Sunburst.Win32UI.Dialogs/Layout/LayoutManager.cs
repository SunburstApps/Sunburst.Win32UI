...
namespace Sunburst.Win32UI.Layout
{
    ...
    public sealed class LayoutManager
    {
        ...
        private NativeWindow mOwner = null;
        private Rect mLastRect = Rect.Zero;

        public LayoutManager(NativeWindow owner)
        {
            mOwner = owner;
            mLastRect = owner.ClientRect;
        }

        public void Add(NativeWindow window, LayoutPosition position)
        {
        ...
        public void Remove(IWin32Window window)
        {
        ...
        public void SetPosition(IWin32Window window, LayoutPosition position)
        {
            foreach (var item in mControls)
            {
        ...
        public void UpdateLocation(NativeWindow window)
        {
            Rect rect = window.WindowRect;
            Point pt = new Point(rect.left, rect.top);
            NativeMethods.ScreenToClient(mOwner.Handle, ref pt);
