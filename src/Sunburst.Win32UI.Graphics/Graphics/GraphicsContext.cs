...
namespace Sunburst.Win32UI.Graphics
{
    public class GraphicsContext : IDisposable
    {
        ...
        protected GraphicsContext() : this(IntPtr.Zero) { }

        public GraphicsContext(IntPtr ptr)
        {
            Handle = ptr;
        }
        ...
        public bool BitBlt(GraphicsContext source, Rect frame)
        {
            return BitBlt(source, frame, Point.Zero);
        }

        public bool BitBlt(GraphicsContext source, Rect destinationFrame, Point sourcePoint)
        {
        ...
        public bool StretchBlt(GraphicsContext source, Rect destinationFrame, Rect sourceFrame)
        {
            const int ROP_SRCCOPY = 0x00CC0020;
